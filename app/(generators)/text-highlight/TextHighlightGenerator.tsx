...
const LEVEL_COLORS: Record<Level, { bg: string; fg: string; name: string }> = {
  1: { bg: "#F2B077", fg: "#1C1B17", name: "Sand — critical" },
  2: { bg: "#F27F3D", fg: "#1C1B17", name: "Dusk — important" },
  3: { bg: "#3786A6", fg: "#FFFFFF", name: "Teal — contextual" },
  4: { bg: "#085A8C", fg: "#FFFFFF", name: "Ocean — reference" },
  5: { bg: "#192640", fg: "#FFFFFF", name: "Navy — peripheral" },
};
